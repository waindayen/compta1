...
interface ManagerApprovalAccessStatsProps {
  totalManagers: number;
  enabledCount: number;
  disabledCount: number;
}

export default function ManagerApprovalAccessStats({ 
  totalManagers, 
  enabledCount, 
  disabledCount 
}: ManagerApprovalAccessStatsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm text-gray-600">Approbation activée</p>
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm text-gray-600">Approbation désactivée</p>
