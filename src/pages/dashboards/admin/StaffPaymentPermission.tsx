...
import StaffPaymentPermissionNav from '../../../components/admin/manager/StaffPaymentPermissionNav';
import StaffPaymentPermissionStats from '../../../components/admin/manager/StaffPaymentPermissionStats';
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-blue-800">
            Activez ou désactivez la possibilité pour les staffs de payer les gains des tickets gagnants.
            Lorsque cette option est désactivée, le bouton "Payer" n'apparaîtra pas pour le staff.
          </p>
        </div>
