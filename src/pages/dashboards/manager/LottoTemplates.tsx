...
import { AlertCircle, Clock, Search, Info, RefreshCw } from 'lucide-react';

export default function ManagerLottoTemplates() {
      ...
      <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center gap-2">
        ...
        <div>
          <p className="text-blue-800">
            En tant que manager, vous pouvez consulter tous les modèles de lottos récurrents et forcer la vérification de récurrence, mais vous ne pouvez pas les modifier ni les supprimer. 
            Les modèles récurrents sont automatiquement créés selon leur fréquence (quotidien, hebdomadaire, annuel). 
